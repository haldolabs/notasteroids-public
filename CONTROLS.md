...
Every binding the game ships with. This table is generated from the game's own keymap, so
...
what you have bought from the E-SHOP. Turn that off under SETTINGS → GAMEPLAY → THROTTLE
CEILING if you preferred it unbounded.
...
| File a bug or a suggestion | `B` |
| Layout inspector (a development overlay) | `L` |

## Where the settings are

**SETTINGS** from the main menu or the pause screen, across five pages: GAMEPLAY TUNING,
DIFFICULTY AND ASSISTS, NARRATION AND VOICE, INTERFACE, and ADVANCED.
